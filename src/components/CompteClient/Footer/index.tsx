const Footer = () => {
  return (
    <>
      <footer className="text-gray-300 bg-black px-4 py-5 max-w-screen mx-auto md:px-8">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="/images/logo/LOGO-QR-MENU.png" className="w-32 sm:mx-auto" />
                <p className="leading-relaxed font-semibold mt-2 text-[15px]">
                    Dabali express, le meilleur fast-food ivoirien.
                </p>
                <h1 className="mt-4 text-base font-semibold">Contactez nous</h1>
                <div className="flex flex-col">
                <p>+225 07 07 07 07 07</p>
                <p>dabaliexpress@gmail.com</p>
                </div>
            </div>
